...
function ItemProject() {
    ...
    const projects = [
        {
            title: "Oh my food",
            description: "Réalisation d'un site responsive vitrine pour les cartes de divers restaurateurs",
            img: pageohmyfood,
        ...
        {
            title: "Print it",
            description: "Création du site d'une entreprise d'impression d'entreprise en utilisant javascript pour l'animation d'un carrousel",
            img: pagePrintit,
        ...
        <div className="gridProjects" style={styles.gridProjects}>
            ...
            <ul style={styles.ul}>
                ...
                >
                    ...
                    {/* <p className="descriptionProject" style={styles.descriptionProject}>{projects[currentIndex].description}</p> */}
